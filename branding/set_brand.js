...
function getTheme(context) {
    ...
    if (!FS.existsSync(`branding/brands/${theme}`)) {
        consoleOut(`hook(set_brand.js) WARNING: the directory 'branding/brands/${theme}' for the theme '${theme}' does not exist`);
        theme = "vanilla";
    }

    consoleOut(`hook(set_brand.js) setting theme to '${theme}'. additional info in 'branding/set_brand.log' and 'branding/README.md'`, false);
    return theme;
}
...
function consoleOut(msg, warning = true) {
