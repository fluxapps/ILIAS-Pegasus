 ...
 * @version 0.0.1
 */
var CreateNews = /** @class */ (function () {
    function CreateNews() {
        this.version = new MigrationVersion("V__4");
    }
    CreateNews.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            var news, usersNewsJunctionTable;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        usersNewsJunctionTable = new Table("users_news", [
                            new TableColumn({ name: "usersId", type: "integer", isPrimary: true, isGenerated: false, isNullable: false }),
                            new TableColumn({ name: "newsId", type: "integer", isPrimary: true, isGenerated: false, isNullable: false })
                        ]);
                        return [4 /*yield*/, queryRunner.createTable(news)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.createTable(usersNewsJunctionTable)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CreateNews.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.dropTable("News")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.dropTable("users_news")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
...
export { CreateNews };
//# sourceMappingURL=V__4-create-news-shema.js.map