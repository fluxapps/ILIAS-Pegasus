...
export var FILE_DOWNLOADER = new InjectionToken("token for file downloader");
/**
 * Standard file download implementation.
 */
var FileDownloaderImpl = /** @class */ (function () {
    function FileDownloaderImpl(http) {
        this.http = http;
        this.log = Logging.getLogger(FileDownloaderImpl_1.name);
        this.requestCounter = 0;
    }
    FileDownloaderImpl_1 = FileDownloaderImpl;
    /**
     ...
     */
    FileDownloaderImpl.prototype.download = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var requestId_1, response, error_1, response_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        requestId_1 = this.generateRequestId();
                        this.log.trace(function () { return "Download-" + requestId_1 + ": Clear cookies for request."; });
                        this.http.clearCookies();
                        this.log.trace(function () { return "Download-" + requestId_1 + ": Redirects enabled: " + options.followRedirects; });
                        this.http.disableRedirect(!options.followRedirects);
                        return [4 /*yield*/, this.http.downloadFile(options.url, options.body, options.headers, options.filePath)];
                    case 1:
                        response = (_a.sent());
                        this.log.trace(function () { return "Download-" + requestId_1 + ": Transfer finished."; });
                    ...
                    case 2:
                        ...
                        this.log.warn(function () { return "The resource download failed with error: " + JSON.stringify(error_1); });
                        throw new HttpRequestError(0, "The resource download failed with error: " + JSON.stringify(error_1));
     ...
     */
    FileDownloaderImpl.prototype.generateRequestId = function () {
        if (this.requestCounter === Number.MAX_SAFE_INTEGER)
            this.requestCounter = 0;
        return ++this.requestCounter;
    };
    var FileDownloaderImpl_1;
    FileDownloaderImpl = FileDownloaderImpl_1 = __decorate([
        Injectable({
            providedIn: "root"
        }),
