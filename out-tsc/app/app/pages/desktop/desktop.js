 ...
 */
var DesktopPage = /** @class */ (function () {
    function DesktopPage(openInIliasActionFactory, linkBuilder) {
        this.openInIliasActionFactory = openInIliasActionFactory;
        this.linkBuilder = linkBuilder;
        this.installations = [];
    }
    DesktopPage.prototype.switchTabs = function (tab) {
    ...
    DesktopPage.prototype.openILIASRepository = function () {
        return __awaiter(this, void 0, void 0, function () {
            var REFID_REPOSITORY;
            return __generator(this, function (_a) {
                REFID_REPOSITORY = 1;
    ...
    DesktopPage = __decorate([
        ...
        __param(0, Inject(OPEN_OBJECT_IN_ILIAS_ACTION_FACTORY)),
        __param(1, Inject(LINK_BUILDER)),
