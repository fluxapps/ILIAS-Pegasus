...
export var DEFAULT_LINK_BUILDER = new InjectionToken("token for the default link builder factory");
var DefaultLinkBuilderImpl = /** @class */ (function () {
    function DefaultLinkBuilderImpl(installationLinkSupplier, tokenSupplier, userRepository) {
     ...
     */
    DefaultLinkBuilderImpl.prototype.target = function (refId) {
        this.refId = refId;
        return this;
    };
    /**
     ...
     */
    DefaultLinkBuilderImpl.prototype.build = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = (_a.sent())
                            .orElseThrow(function () { return new NoSuchElementError("No authenticated user found, unable to build default ILIAS link."); });
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, installation + "/goto.php?target=ilias_app_auth|" + user.iliasUserId + "|" + this.refId + "|default|" + token];
                }
            });
        });
    };
     ...
     */
    DefaultLinkBuilderImpl.prototype.validateBuilderState = function () {
        if (this.refId <= 0)
            throw new IllegalStateError("Required ref id was not found, ILIAS default link build failed.");
    };
    DefaultLinkBuilderImpl = __decorate([
        Injectable({
            providedIn: "root"
        }),
    ...
    return DefaultLinkBuilderImpl;
}());
export { DefaultLinkBuilderImpl };
//# sourceMappingURL=default.builder.js.map