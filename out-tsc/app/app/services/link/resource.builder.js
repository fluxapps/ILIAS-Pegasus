...
export var RESOURCE_LINK_BUILDER = new InjectionToken("token for the resource link builder factory");
var ResourceLinkBuilderImpl = /** @class */ (function () {
    function ResourceLinkBuilderImpl(installationLinkSupplier, tokenSupplier, userRepository) {
     ...
     */
    ResourceLinkBuilderImpl.prototype.resource = function (path) {
        this.path = path;
        return this;
    };
    /**
     ...
     */
    ResourceLinkBuilderImpl.prototype.build = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = (_a.sent())
                            .orElseThrow(function () { return new NoSuchElementError("No authenticated user found, unable to build resource ILIAS link."); });
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, installation + "/" + this.path + "?user=" + user.iliasUserId + "&token=" + token + "&target=ilias_app_resource"];
                }
            });
        });
    };
     ...
     */
    ResourceLinkBuilderImpl.prototype.validateBuilderState = function () {
    ...
    ResourceLinkBuilderImpl = __decorate([
        Injectable({
            providedIn: "root"
        }),
    ...
    return ResourceLinkBuilderImpl;
}());
export { ResourceLinkBuilderImpl };
