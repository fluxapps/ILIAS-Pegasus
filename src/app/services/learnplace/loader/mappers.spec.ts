...
describe("a picture block mapper", () => {
    ...
    let mockPathBuilder: jasmine.SpyObj<LearnplacePathBuilder> = createSpyObject(LearnplacePathBuilderImpl);
        ...
        describe("on new picture blocks", () => {
            ...
            it("should create new picture block entities and transfer its pictures", async() => {
                ...
                const remote: Array<PictureBlock> = [
                    <PictureBlock>{
                        id: 1, sequence: 3, visibility: "ALWAYS", title: "title", description: "",
                        thumbnail: "get/thumbnail.png", thumbnailHash: "=1e", url: "get/picture/1", hash: "=2e"
                    },
                    <PictureBlock>{
                        id: 2, sequence: 4, visibility: "NEVER", title: "title 2", description: "",
...
describe("a accordion mapper", () => {
    ...
    let mockTextMapper: jasmine.SpyObj<TextBlockMapper> = createSpyObject(TextBlockMapper);
    let mockPictureMapper: jasmine.SpyObj<PictureBlockMapper> = createSpyObject(PictureBlockMapper);
    let mockLinkMapper: jasmine.SpyObj<LinkBlockMapper> = createSpyObject(LinkBlockMapper);
    let mockVideoMapper: jasmine.SpyObj<VideoBlockMapper> = createSpyObject(VideoBlockMapper);
        ...
        describe("on new accordion blocks", () => {
            ...
            it("should create new accordion entities", async() => {
                ...
                const remote: Array<AccordionBlock> = [
                    <AccordionBlock>{
                        id: 1, sequence: 1, title: "title", expanded: true, visibility: "ALWAYS", text: [
                            <TextBlock>{id: 1, sequence: 1, content: "", visibility: "ALWAYS"}
                        ]
                    },
                    <AccordionBlock>{
                        id: 2, sequence: 2, title: "title", expanded: true, visibility: "ALWAYS", text: [
